...
FUNCTION(alimer_add_sample TARGET_NAME)	
	...
	elseif (ALIMER_PLATFORM_ANDROID)
		...
		target_link_libraries (${TARGET_NAME} log android EGL GLESv2 cpufeatures native_app_glue)
	elseif (ALIMER_PLATFORM_WEB)
		add_executable (${TARGET_NAME} ${ARGN} ${EXTRA_FILES})
		set_target_properties(${TARGET_NAME} PROPERTIES RELEASE_POSTFIX .html)
		set_target_properties(${TARGET_NAME} PROPERTIES DEBUG_POSTFIX .html)
        	set_target_properties(${TARGET_NAME} PROPERTIES PROFILING_POSTFIX .html)
	else()
		add_library (${TARGET_NAME} SHARED ${ARGN} ${EXTRA_FILES})
	endif()
